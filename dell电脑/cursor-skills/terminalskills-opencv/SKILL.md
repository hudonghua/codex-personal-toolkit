---
name: terminalskills-opencv
description: >-
  Extended OpenCV workflows (Python/C++): pipelines, contours, threshold/morphology,
  video I/O, camera calibration, 3D reconstruction, DNN inference. Use when basic
  opencv skill is insufficient or for calibration and production-style CV code.
license: Apache-2.0
compatibility: ''
metadata:
