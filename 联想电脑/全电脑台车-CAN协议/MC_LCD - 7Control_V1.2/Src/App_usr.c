...
static void Arm200A_ClearCan2Buf(void)
{
	unsigned char i;
	for(i = 0; i < 8; i++)
	{
...
static void Arm200A_SendPointFrame(unsigned char b0, long value)
{
	Arm200A_ClearCan2Buf();
	CAN_SBuf2[0] = b0;
	Arm200A_PackS32(1, value);
	CAN2_SendX(0x150, CAN_SBuf2);
}

static void Arm200A_SendAngleFrame(unsigned char b0, int v0, int v1, int v2)
{
	Arm200A_ClearCan2Buf();
	CAN_SBuf2[0] = b0;
	Arm200A_PackS16(1, v0);
	Arm200A_PackS16(3, v1);
	Arm200A_PackS16(5, v2);
	CAN2_SendX(0x154, CAN_SBuf2);
}

static void Arm200A_SendPlaneFrame(unsigned char b0, ARM200A_H1_INFO *h1)
{
	Arm200A_ClearCan2Buf();
	CAN_SBuf2[0] = b0;
...
void CAN_Send_data(void )
{
	...
	static unsigned char send80msStep = 0;
	...
	if(send50msActive)
	{
		...
		{
			case 0:
				Arm200A_SendPointFrame(0x10, Arm200A_FloatToLongX100(gArmLeftOut.h.x));
				break;

			case 1:
				Arm200A_SendPointFrame(0x11, Arm200A_FloatToLongX100(gArmLeftOut.h.y));
				break;

			case 2:
				Arm200A_SendPointFrame(0x12, Arm200A_FloatToLongX100(gArmLeftOut.h.z));
				break;

			case 3:
				Arm200A_SendPointFrame(0x20, Arm200A_FloatToLongX100(gArmMidOut.h.x));
				break;

			case 4:
				Arm200A_SendPointFrame(0x21, Arm200A_FloatToLongX100(gArmMidOut.h.y));
				break;

			case 5:
				Arm200A_SendPointFrame(0x22, Arm200A_FloatToLongX100(gArmMidOut.h.z));
				break;

			case 6:
				Arm200A_SendPointFrame(0x30, Arm200A_FloatToLongX100(gArmRightOut.h.x));
				break;

			case 7:
				Arm200A_SendPointFrame(0x31, Arm200A_FloatToLongX100(gArmRightOut.h.y));
				break;

			case 8:
				Arm200A_SendPointFrame(0x32, Arm200A_FloatToLongX100(gArmRightOut.h.z));
				break;
	...
	if(send80msActive)
	{
		...
		{
			case 0:
				Arm200A_SendPlaneFrame(0x10, &gArmLeftH1Info);
				break;

			case 1:
				Arm200A_SendPlaneFrame(0x20, &gArmMidH1Info);
				break;

			default:
				Arm200A_SendPlaneFrame(0x30, &gArmRightH1Info);
				break;
		}
	...
	if(send150msActive)
	{
		...
		{
			case 0:
				Arm200A_SendAngleFrame(0x10, Arm200A_FloatToS16X100(gArmLeftRaw.root_raw), Arm200A_FloatToS16X100(gArmLeftRaw.base_raw), Arm200A_FloatToS16X100(gArmLeftRaw.boom_raw));
				break;

			case 1:
				Arm200A_SendAngleFrame(0x11, Arm200A_FloatToS16X100(gArmLeftRaw.d1_raw), Arm200A_FloatToS16X100(gArmLeftRaw.e1_raw), Arm200A_FloatToS16X100(gArmLeftRaw.f_raw));
				break;

			case 2:
				Arm200A_SendAngleFrame(0x12, Arm200A_FloatToS16X100(gArmLeftRaw.cd_raw), Arm200A_FloatToS16X100(gArmLeftRaw.gg1_raw), 0);
				break;

			case 3:
				Arm200A_SendAngleFrame(0x20, 0, Arm200A_FloatToS16X100(gArmMidRaw.base_raw), Arm200A_FloatToS16X100(gArmMidRaw.boom_raw));
				break;

			case 4:
				Arm200A_SendAngleFrame(0x21, Arm200A_FloatToS16X100(gArmMidRaw.d1_raw), Arm200A_FloatToS16X100(gArmMidRaw.e1_raw), Arm200A_FloatToS16X100(gArmMidRaw.f_raw));
				break;

			case 5:
				Arm200A_SendAngleFrame(0x22, Arm200A_FloatToS16X100(gArmMidRaw.cd_raw), Arm200A_FloatToS16X100(gArmMidRaw.gg1_raw), 0);
				break;

			case 6:
				Arm200A_SendAngleFrame(0x30, Arm200A_FloatToS16X100(gArmRightRaw.root_raw), Arm200A_FloatToS16X100(gArmRightRaw.base_raw), Arm200A_FloatToS16X100(gArmRightRaw.boom_raw));
				break;

			case 7:
				Arm200A_SendAngleFrame(0x31, Arm200A_FloatToS16X100(gArmRightRaw.d1_raw), Arm200A_FloatToS16X100(gArmRightRaw.e1_raw), Arm200A_FloatToS16X100(gArmRightRaw.f_raw));
				break;

			default:
				Arm200A_SendAngleFrame(0x32, Arm200A_FloatToS16X100(gArmRightRaw.cd_raw), Arm200A_FloatToS16X100(gArmRightRaw.gg1_raw), 0);
				break;
		}
