...
#define PLL0_SETUP            1
//#define PLL0CFG_Val           0x0000000B		// 12*2*(0x0b+1) = 288MHz
#define PLL0CFG_Val           0x0000000F		// 12*2*(0x0f+1) = 384MHz
#define PLL1_SETUP            1
#define PLL1CFG_Val           0x00000003
#define CCLKCFG_Val           0x00000003		// 384/(3+1) = 96MHz
//#define CCLKCFG_Val           0x00000005 		// 288/(3+1) = 72MHz
#define USBCLKCFG_Val         0x00000000
#define PCLKSEL0_Val          0x00000000
#define PCLKSEL1_Val          0x00000000
//#define PCLKSEL0_Val          0x2a0002aa 		// 01--PClk == CClk	 00--PClk == CClk/4
//#define PCLKSEL1_Val          0x0000a000
//#define PCONP_Val             0x042887DE		// Default
#define PCONP_Val             0x0000808A
